...
class Human:
    ...
    def __add_to_building_inhabitants(self):
        if self.living_place:
            print(
                f"adding the human {self.name} to the living place {self.living_place.address}")
    ...
    def __remove_from_building_inhabitants(self):
        if self.living_place:  # self.living_place != None
            print(
                f"removing the human {self.name} from the current living place {self.living_place.address}")
