...
def add_new_users(name, address, language_code):
    x = dict(name=name, address=address, language_code=language_code)
    users.append(x)


add_new_users(fake.name(), fake.address(), fake.language_code())
add_new_users(fake.name(), fake.address(), fake.language_code())
add_new_users(fake.name(), fake.address(), fake.language_code())
print(users)
